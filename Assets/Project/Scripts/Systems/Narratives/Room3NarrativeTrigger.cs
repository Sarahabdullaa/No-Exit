...
public class Room3NarrativeTrigger : MonoBehaviour
{
    ...
    [TextArea]
    public string objectiveMessage = "Objective: Search the room carefully.";
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            hasTriggered = true;
            StartCoroutine(PlayRoom3Narrative());
        }
    }

    IEnumerator PlayRoom3Narrative()
    {
